export const ourMethodsData = {
	...
	natura_i_ruch: [
		`Potrzebę ruchu najmłodszych zaspokajamy w najprostszy i naturalny sposób, wykorzystując
    dziecięcą chęć baraszkowania, spontaniczną zabawę i radość.`,
...
dziecko „brudne” to dziecko szczęśliwe :)`,
    ...
    nieograniczona. Każde dziecko, bez względu na swoje zdolności, kiedy tworzy, jest szczęśliwe
    i radosne.`,
		`Udowodniono, że samodzielne tworzenie (czy choćby odtwarzanie) sztuki sprawia, że mózg
    pracuje jeszcze szybciej niż podczas samego jej odbierania. Zdaniem neurologów kontakt ze
    sztuką pobudza mózg do pracy i znacząco wpływa na jego rozwój. Stymulując receptory
    wpływamy na rozwój połączeń nerwowych, których im więcej, tym łatwiej i szybciej
    przebiega proces uczenia się, przyswajania oraz wszelkie procesy analizy i syntezy w umyśle.`,
		`Różnorodne aktywności maluszków w ramach Pracowni Manualnej mają również korzystny
    wpływ na rozwój motoryki małej. Przygotowujemy rączki do pisania, ćwiczymy koncentrację
    uwagi, pamięć oraz rozwijamy wyobraźnię.`,
	],
};
